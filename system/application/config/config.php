...
// ------------------------------------------------------------------------------
// Patch GoalBit (permitimos no limpiar los siguientes parametros del GET o POST)
$config['dirty_variables'] = array('info_hash', 'peer_id');
// ------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------
// Patch GoalBit (mantenemos las URL del framework, agregando parametros por GET)
...
|
*/
$config['encryption_key'] = "oSiej23djf3203jcs2n0SDSDsd2309dw";
...
|
*/
$config['sess_cookie_name']		= 'gwt_session';
$config['sess_expiration']		= 7200;
$config['sess_encrypt_cookie']	= TRUE;
$config['sess_use_database']	= FALSE;
$config['sess_table_name']		= 'gwt_sessions';
...
/*
|--------------------------------------------------------------------------
| GoalBit Tracker parameters
|--------------------------------------------------------------------------
|
*/

// Supported Protocol
DEFINE( 'GOALBIT_PROTOCOL_VERSION', 'goalbit-0.6');

// Peer Types:
DEFINE( 'BROADCASTER_PEER'      , 1 );
DEFINE( 'SUPER_PEER'            , 2 );
DEFINE( 'NORMAL_PEER'           , 3 );
DEFINE( 'BROADCASTER_SUPER_PEER', 4 );

// Peer SubTypes:
DEFINE( 'PURE_PEER'   , 1 );
DEFINE( 'MONITOR_PEER', 2 );
DEFINE( 'PUMPER_PEER' , 3 );

// Max number of peer inside the swarm to deliver to a peer
DEFINE( 'MAX_PEERS_TO_RETURN', 100 );

// Max piece ID
DEFINE( 'MAX_PIECE_ID', 2147483648 );

// NULL Constant
DEFINE( 'BT_NULL', (MAX_PIECE_ID + 1) );

// Chunk en bytes
DEFINE( 'CHUNK_SIZE', 65536 );

// 250 video + 32 audio (kilobits/sec)
DEFINE( 'STREAM_BITRATE', 282.0 );

// Chunk consumption rate
DEFINE( 'CHUNK_RATE', (float)((CHUNK_SIZE*8/1000) / STREAM_BITRATE) );

// Some tracker behaviour tunable
DEFINE( 'CLIENT_REQUEST_INTERVAL' , 30 );
DEFINE( 'CLIENT_REQUEST_VARIATION', 6 );
DEFINE( 'PEERS_TIMEOUT'           , 90 );
DEFINE( 'ABI_MARGIN'              , 20 );


DEFINE( 'UPLOAD_RUTE', "uploaded/" );
DEFINE( 'EXAMPLE_ROUTE', "examples/" );
...
DEFINE ('STARTERSUITE_VERSION', '0.7.6');
